_base_ = []
custom_imports = dict(imports=['plugin.TopoNet.bevformer', 'plugin.TopoNet.toponet'])
...
model = dict(
    type='TopoNet',
    init_cfg=dict(type='Pretrained', checkpoint='work_dirs/toponet_r50_1_24e_olv2_subset_A/latest.pth'),
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
