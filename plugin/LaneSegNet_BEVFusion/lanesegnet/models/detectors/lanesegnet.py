...
class LaneSegNet(MVXTwoStageDetector):
    ...
    # camera only 
    def extract_feat(self, img, lidar2image,camera_intrinsics, camera2lidar, img_metas=None, len_queue=None):
    ...
    def forward_train(self,
        ...
        if img is not None: 
            ...
            for i, meta in enumerate(img_metas):
                lidar2image.append(meta['lidar2img']) # yes 
                camera_intrinsics.append(meta['cam_intrinsic']) # yes 
                camera2lidar.append(meta['lidar2cam'])
            ...
            # img_aug_matrx, lidar_aug_matrix 
