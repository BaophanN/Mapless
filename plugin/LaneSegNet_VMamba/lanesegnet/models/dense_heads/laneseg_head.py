...
class LaneSegHead(AnchorFreeHead):
    ...
    def forward(self, mlvl_feats, bev_feats, img_metas):
        ...
        outs = {
            'all_cls_scores': outputs_classes, # cls result
            'all_lanes_preds': outputs_coords, # coords of predicted lanes
            'all_mask_preds': outputs_masks,   # masks for segmentation
            'all_lanes_left_type': output_left_types, # cls of left types lanes
            'all_lanes_right_type': output_right_types, # cls of right types lanes 
            'history_states': hs    # history states 
        }
        return outs
